  ...
  "relative w-full rounded-xl border p-4 backdrop-blur-sm animate-fade-in [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-red-500/10 border-red-500/30 text-red-200 [&>svg]:text-red-400",
        success: "bg-emerald-500/10 border-emerald-500/30 text-emerald-200 [&>svg]:text-emerald-400",
        warning: "bg-amber-500/10 border-amber-500/30 text-amber-200 [&>svg]:text-amber-400",
